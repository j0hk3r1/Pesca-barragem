...
> ⏱️ Tempo de carro ao comboio = **estimativa** (estradas reais; na serra o Google dá +10–20%) → clica em **🚗 rota** para o tempo exato.
...
**🏆 Resumo:** pescar tudo sem chatices → **Janeiro de Baixo**. Variedade + grupo → **3 Entradas / Côja**. Truta + comboio → **Valhelhas**. Fora → **Vale do Rossim**.
