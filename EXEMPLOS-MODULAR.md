...
## ✨ Spinning — amostra
<img src="img/montagem-spinning.svg" alt="Montagem spinning" width="430" height="330">
...
🪢 **Nós:** [FG ou Albright](NOS.md) (multi→leader) · [clinch melhorado](NOS.md) (leader→snap).
...
🪢 **Nós:** [palomar](NOS.md) (multi→barril) · [clinch melhorado](NOS.md) (→anzol).
...
<img src="img/montagem-modular.svg" alt="Sistema modular" width="500" height="379">

**3 regras (importantes):**
1. **Nó no multi = [palomar](NOS.md) ou [uni](NOS.md), NÃO clinch.** Multi é escorregadio; o clinch desliza e solta. Atas **1 vez**, dura imenso.
...
> 💡 O [**nó FG**](NOS.md) não se desfaz a cada saída — dura várias. O snap só acelera trocas; não é obrigatório.
...
<img src="img/distancia-lancamento.svg" alt="Distância de lançamento por peixe" width="720" height="417">
...
> Cada peixe → ✅ a **melhor maneira** · ➕ **alternativas** · 💡 **dica**. Cana: 🪶 pequena (leve) · 💪 grande (fundo).
...
```
- ✅ **Melhor:** **vinil** (senko/shad) Texas ou wacky, junto a **estrutura** (pedras, troncos, vegetação) — não enrosca e cobre tudo. Cores naturais em água limpa.
- ➕ **Também dá:** **colher/spinnerbait** em água aberta · **superfície** (popper) ao amanhecer/anoitecer no verão · **jig** no fundo.
- 💡 **Dica:** recolhe com **paragens** — o ataque vem quase sempre na pausa/queda. Calor → topo; água fria → fundo e devagar.
...
```
- ✅ **Melhor:** **boia leve** com **larva (asticot)** branca/vermelha ou massa, a **meia-água**, perto da margem.
- ➕ **Também dá:** **fundo leve** (light ledger) com massa ou pão.
- 💡 **Dica:** **cardume** → engodo de farinhas (amendoim) mantém-nos por baixo. Boca pequena → **anzol #14–16** e isco pequeno.
...
- ✅ **Melhor:** **boia** com **minhoca pequena** ou larva, à margem. Montagem **igual à boga** ([acima](EXEMPLOS-MODULAR.md#ex-boga)), anzol **#14**.
- ➕ **Também dá:** é **predadora voraz** → morde **micro-vinil** ou um **pequeno spinner** (divertido) · fundo leve.
- 💡 **Dica:** morde tudo → **ótima para praticar a ferrar** e para começar. Invasor — algumas zonas pedem não devolver ([Regras](REGRAS.md)).
...
```
- ✅ **Melhor:** **ao fundo** com isco **cheiroso** (chouriço, fígado, minhoca), ao **anoitecer/noite**.
- ➕ **Também dá:** **boia** rente ao fundo com o mesmo isco (vês melhor a mordida).
