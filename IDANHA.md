...
- 💧 **Nível** ([SNIRH](https://snirh.apambiente.pt)): padrão dos últimos verões = **~74% (jul) → ~62-64% (ago) → ~56% (set)**. Margens **bem abaixo** do satélite — trilhos até à água mais compridos, margem de lodo/pedra exposta: **botas**.
